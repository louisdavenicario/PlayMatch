...
<template>
  <v-app :theme="theme">
      ...
      <v-container>
        ...
        <v-row justify="center" align="center" style="max-width: 1100px; width: 100%;" class="mx-auto pa-4 pa-md-10">
          ...
          <v-col 
            ...
            md="6" 
            lg="4" 
            class="d-flex justify-center justify-md-start mx-auto"
            style="max-width: 400px; padding: 0;"
          >
            <v-card
              class="pt-10 text-center"
              elevation="10"
              style="background-color: rgba(255, 255, 255, 0.88); backdrop-filter: blur(4px); border: 2px solid #2196f3; border-radius: 20px;"
            >
              <v-img
                class="mx-auto mb-6"
                src="/images/logo.png"
              ...
              <div class="px-6 pb-6">
                ...
                <p class="text-center text-body-2 mt-6">
                  ...
                  <router-link :to="{ path: '/signin' }" class="text-primary font-weight-bold text-decoration-none">
                    Sign In
                  </router-link>
                </p>
              </div>
    ...
    <v-footer border app class="text-center">
      <v-col class="text-center">© 2025 Playmatch</v-col>
    </v-footer>
  </v-app>
</template>